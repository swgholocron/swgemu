...
ObjectTemplates:addTemplate(object_tangible_wearables_bodysuit_bodysuit_tie_fighter_quest, "object/tangible/wearables/bodysuit/bodysuit_tie_fighter_quest.iff")
