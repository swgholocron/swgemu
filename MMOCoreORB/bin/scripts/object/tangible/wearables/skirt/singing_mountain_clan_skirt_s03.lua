...
ObjectTemplates:addTemplate(object_tangible_wearables_skirt_singing_mountain_clan_skirt_s03, "object/tangible/wearables/skirt/singing_mountain_clan_skirt_s03.iff")
