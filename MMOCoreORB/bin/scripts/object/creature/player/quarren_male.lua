...
object_creature_player_quarren_male = object_creature_player_shared_quarren_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_quarren_male, "object/creature/player/quarren_male.iff")
