...
object_creature_player_bith_female = object_creature_player_shared_bith_female:new {
...
ObjectTemplates:addTemplate(object_creature_player_bith_female, "object/creature/player/bith_female.iff")
