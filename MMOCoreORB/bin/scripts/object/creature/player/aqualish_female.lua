...
object_creature_player_aqualish_female = object_creature_player_shared_aqualish_female:new {
...
ObjectTemplates:addTemplate(object_creature_player_aqualish_female, "object/creature/player/aqualish_female.iff")
