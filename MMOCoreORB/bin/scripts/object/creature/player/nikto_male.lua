...
object_creature_player_nikto_male = object_creature_player_shared_nikto_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_nikto_male, "object/creature/player/nikto_male.iff")
